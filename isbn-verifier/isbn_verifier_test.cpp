...
TEST_CASE("valid_isbn") { REQUIRE(isbn_verifier::is_valid("3-598-21508-8")); }
...
TEST_CASE("too_short_isbn") { REQUIRE_FALSE(isbn_verifier::is_valid("00")); }
...
TEST_CASE("empty_isbn") { REQUIRE_FALSE(isbn_verifier::is_valid("")); }
