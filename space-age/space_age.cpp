...
space_age::space_age(long long int sec) : _seconds(sec) {}

unsigned space_age::seconds() const {return _seconds;}
double space_age::on_earth() const {return 1.0 * _seconds / 31557600;}
