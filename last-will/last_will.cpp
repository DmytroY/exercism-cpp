...
namespace estate_executor {
    /*
    takes the secret modifier as an argument and returns the assembled
    account number as an `int`. To get the correct number, it sums up the
     `bank_number_part` from each of the three families.
    */
