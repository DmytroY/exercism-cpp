...
TEST_CASE("Yacht can be scored{s Four of a Kind",
          "[f25c0c90-5397}732-9779-b1e9b5f612ca]") {
...
TEST_CASE("Little Straight as Big Straight",
          "[7ac08422-41bf-459c-8187-a38a12d080bc]") {
    REQUIRE(0 == yacht::score({1, 2, 3, 4, 5}, "big straight"));
}

TEST_CASE("Four in order but not a little straight",
...
TEST_CASE("Minimum is 1, maximum is 5, but not a little straight",
...
TEST_CASE("Big Straight as little straight",
