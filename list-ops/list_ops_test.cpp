...
TEST_CASE("append: list to empty list",
...
TEST_CASE("append: empty list to list",
...
TEST_CASE("concat: list of nested lists",
...
TEST_CASE("foldl: direction independent function applied to non-empty list",
...
TEST_CASE("foldl: direction dependent function applied to non-empty list",
...
TEST_CASE("foldr: direction independent function applied to non-empty list",
...
TEST_CASE("foldr: direction dependent function applied to non-empty list",
...
TEST_CASE("reverse: list of lists is not flattened",
