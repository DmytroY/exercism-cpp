...
TEST_CASE("pop gets element from the list",
...
TEST_CASE("push/pop respectively add/remove at the end of the list",
...
TEST_CASE("shift gets an element from the list",
...
TEST_CASE("shift gets first element from the list",
...
TEST_CASE("unshift adds element at start of the list",
...
TEST_CASE("pop, push, shift, and unshift can be used in any order",
...
TEST_CASE("count is correct after mutation",
...
TEST_CASE("popping to empty doesn't break the list",
...
TEST_CASE("shifting to empty doesn't break the list",
...
TEST_CASE("erases the element with the specified value from the list",
...
TEST_CASE("erases the first of two elements",
...
TEST_CASE("erase does not modify the list if the element is not found",
...
TEST_CASE("erases only the first occurrence",
